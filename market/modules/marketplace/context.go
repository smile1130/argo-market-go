...
type Context struct {
	*util.Context
	...
	Success     string `json:"error,omitempty"`
	...
	ViewProfileUser            *User                      `json:"profile_user,omitempty"`
	...
	ViewPackage        *Package         `json:"-"`
	ViewPackages       []Package       `json:"-"`
	...
	ViewNotification      *Notification `json:"notification,omitempty"`
	ViewNotifications      []Notification `json:"notificationsomitempty"`
